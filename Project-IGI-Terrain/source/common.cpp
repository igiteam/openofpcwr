...
================================================================================
*/
static int16_t SwapInt16(int16_t v) {
	union {
		int16_t	i;
		int8_t	b[2];
	} v1, v2;
...
static uint16_t SwapUInt16(uint16_t v) {
	union {
		uint16_t    i;
		int8_t	    b[2];
	} v1, v2;
...
static uint32_t SwapUInt32(uint32_t v) {
	union {
		uint32_t    i;
		int8_t	    b[4];
	} v1, v2;
...
static int64_t SwapInt64(int64_t v) {
	union {
		int64_t	i;
		int8_t	b[8];
	} v1, v2;
...
static uint64_t SwapUInt64(uint64_t v) {
	union {
		uint64_t	i;
		int8_t	b[8];
	} v1, v2;
...
static int16_t NoSwapInt16(int16_t v) {
	return v;
}

static uint16_t NoSwapUInt16(uint16_t v) {
	return v;
}

static int32_t NoSwapInt32(int32_t v) {
	return v;
}

static uint32_t NoSwapUInt32(uint32_t v) {
	return v;
}

static int64_t NoSwapInt64(int64_t v) {
	return v;
}

static uint64_t NoSwapUInt64(uint64_t v) {
	return v;
}

static float NoSwapFloat(float v) {
	return v;
}

static double NoSwapDouble(double v) {
	return v;
}

// native to little-endian
int16_t	(*Swap_Int16ToLit)	(int16_t v);
uint16_t(*Swap_UInt16ToLit)	(uint16_t v);
int32_t	(*Swap_Int32ToLit)	(int32_t v);
uint32_t(*Swap_UInt32ToLit)	(uint32_t v);
int64_t	(*Swap_Int64ToLit)	(int64_t v);
uint64_t(*Swap_UInt64ToLit)	(uint64_t v);
float	(*Swap_FloatToLit)	(float v);
double	(*Swap_DoubleToLit)	(double v);

// native to big-endian
int16_t	(*Swap_Int16ToBig)	(int16_t v);
uint16_t(*Swap_UInt16ToBig)	(uint16_t v);
int32_t	(*Swap_Int32ToBig)	(int32_t v);
uint32_t(*Swap_UInt32ToBig)	(uint32_t v);
int64_t	(*Swap_Int64ToBig)	(int64_t v);
uint64_t(*Swap_UInt64ToBig)	(uint64_t v);
float	(*Swap_FloatToBig)	(float v);
double	(*Swap_DoubleToBig)	(double v);

// little-endian to native
int16_t	(*Swap_LitToInt16)	(int16_t v);
uint16_t(*Swap_LitToUInt16)	(uint16_t v);
int32_t	(*Swap_LitToInt32)	(int32_t v);
uint32_t(*Swap_LitToUInt32)	(uint32_t v);
int64_t	(*Swap_LitToInt64)	(int64_t v);
uint64_t(*Swap_LitToUInt64)	(uint64_t v);
float	(*Swap_LitToFloat)	(float v);
double	(*Swap_LitToDouble)	(double v);

// big-endian to native
int16_t	(*Swap_BigToInt16)	(int16_t v);
uint16_t(*Swap_BigToUInt16)	(uint16_t v);
int32_t	(*Swap_BigToInt32)	(int32_t v);
uint32_t(*Swap_BigToUInt32)	(uint32_t v);
int64_t	(*Swap_BigToInt64)	(int64_t v);
uint64_t(*Swap_BigToUInt64)	(uint64_t v);
float	(*Swap_BigToFloat)	(float v);
double	(*Swap_BigToDouble)	(double v);

bool Swap_IsLittleEndian() {
	union {
		short	s;
		char	b[2];
	} swap_test;
	...
	return 1 == swap_test.s;
}

void Swap_Init() {
	if (Swap_IsLittleEndian()) { // little-endian machine
		Swap_Int16ToLit = NoSwapInt16;
		Swap_UInt16ToLit = NoSwapUInt16;
		Swap_Int32ToLit = NoSwapInt32;
		Swap_UInt32ToLit = NoSwapUInt32;
		Swap_Int64ToLit = NoSwapInt64;
		Swap_UInt64ToLit = NoSwapUInt64;
		Swap_FloatToLit = NoSwapFloat;
		Swap_DoubleToLit = NoSwapDouble;

		Swap_Int16ToBig = SwapInt16;
		Swap_UInt16ToBig = SwapUInt16;
		Swap_Int32ToBig = SwapInt32;
		Swap_UInt32ToBig = SwapUInt32;
		Swap_Int64ToBig = SwapInt64;
		Swap_UInt64ToBig = SwapUInt64;
		Swap_FloatToBig = SwapFloat;
		Swap_DoubleToBig = SwapDouble;

		Swap_LitToInt16 = NoSwapInt16;
		Swap_LitToUInt16 = NoSwapUInt16;
		Swap_LitToInt32 = NoSwapInt32;
		Swap_LitToUInt32 = NoSwapUInt32;
		Swap_LitToInt64 = NoSwapInt64;
		Swap_LitToUInt64 = NoSwapUInt64;
		Swap_LitToFloat = NoSwapFloat;
		Swap_LitToDouble = NoSwapDouble;

		Swap_BigToInt16 = SwapInt16;
		Swap_BigToUInt16 = SwapUInt16;
		Swap_BigToInt32 = SwapInt32;
		Swap_BigToUInt32 = SwapUInt32;
		Swap_BigToInt64 = SwapInt64;
		Swap_BigToUInt64 = SwapUInt64;
		Swap_BigToFloat = SwapFloat;
		Swap_BigToDouble = SwapDouble;
	}
	else { // big-endian machine
		Swap_Int16ToLit = SwapInt16;
		Swap_UInt16ToLit = SwapUInt16;
		Swap_Int32ToLit = SwapInt32;
		Swap_UInt32ToLit = SwapUInt32;
		Swap_Int64ToLit = SwapInt64;
		Swap_UInt64ToLit = SwapUInt64;
		Swap_FloatToLit = SwapFloat;
		Swap_DoubleToLit = SwapDouble;

		Swap_Int16ToBig = NoSwapInt16;
		Swap_UInt16ToBig = NoSwapUInt16;
		Swap_Int32ToBig = NoSwapInt32;
		Swap_UInt32ToBig = NoSwapUInt32;
		Swap_Int64ToBig = NoSwapInt64;
		Swap_UInt64ToBig = NoSwapUInt64;
		Swap_FloatToBig = NoSwapFloat;
		Swap_DoubleToBig = NoSwapDouble;

		Swap_LitToInt16 = SwapInt16;
		Swap_LitToUInt16 = SwapUInt16;
		Swap_LitToInt32 = SwapInt32;
		Swap_LitToUInt32 = SwapUInt32;
		Swap_LitToInt64 = SwapInt64;
		Swap_LitToUInt64 = SwapUInt64;
		Swap_LitToFloat = SwapFloat;
		Swap_LitToDouble = SwapDouble;

		Swap_BigToInt16 = NoSwapInt16;
		Swap_BigToUInt16 = NoSwapUInt16;
		Swap_BigToInt32 = NoSwapInt32;
		Swap_BigToUInt32 = NoSwapUInt32;
		Swap_BigToInt64 = NoSwapInt64;
		Swap_BigToUInt64 = NoSwapUInt64;
		Swap_BigToFloat = NoSwapFloat;
		Swap_BigToDouble = NoSwapDouble;
	}
}
...
bool File_SaveBinary(const char* filename, const void* data, int32_t len) {
