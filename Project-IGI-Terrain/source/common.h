...
extern int16_t	(*Swap_Int16ToLit)	(int16_t v);
extern uint16_t	(*Swap_UInt16ToLit)	(uint16_t v);
extern int32_t	(*Swap_Int32ToLit)	(int32_t v);
extern uint32_t	(*Swap_UInt32ToLit)	(uint32_t v);
extern int64_t	(*Swap_Int64ToLit)	(int64_t v);
extern uint64_t	(*Swap_UInt64ToLit)	(uint64_t v);
extern float	(*Swap_FloatToLit)	(float v);
extern double	(*Swap_DoubleToLit)	(double v);

// native to big-endian
extern int16_t	(*Swap_Int16ToBig)	(int16_t v);
extern uint16_t	(*Swap_UInt16ToBig)	(uint16_t v);
extern int32_t	(*Swap_Int32ToBig)	(int32_t v);
extern uint32_t	(*Swap_UInt32ToBig)	(uint32_t v);
extern int64_t	(*Swap_Int64ToBig)	(int64_t v);
extern uint64_t	(*Swap_UInt64ToBig)	(uint64_t v);
extern float	(*Swap_FloatToBig)	(float v);
extern double	(*Swap_DoubleToBig)	(double v);

// little-endian to native
extern int16_t	(*Swap_LitToInt16)	(int16_t v);
extern uint16_t	(*Swap_LitToUInt16)	(uint16_t v);
extern int32_t	(*Swap_LitToInt32)	(int32_t v);
extern uint32_t	(*Swap_LitToUInt32)	(uint32_t v);
extern int64_t	(*Swap_LitToInt64)	(int64_t v);
extern uint64_t	(*Swap_LitToUInt64)	(uint64_t v);
extern float	(*Swap_LitToFloat)	(float v);
extern double	(*Swap_LitToDouble)	(double v);

// big-endian to native
extern int16_t	(*Swap_BigToInt16)	(int16_t v);
extern uint16_t	(*Swap_BigToUInt16)	(uint16_t v);
extern int32_t	(*Swap_BigToInt32)	(int32_t v);
extern uint32_t	(*Swap_BigToUInt32)	(uint32_t v);
extern int64_t	(*Swap_BigToInt64)	(int64_t v);
extern uint64_t	(*Swap_BigToUInt64)	(uint64_t v);
extern float	(*Swap_BigToFloat)	(float v);
extern double	(*Swap_BigToDouble)	(double v);
